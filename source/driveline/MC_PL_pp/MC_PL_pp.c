...
void MC_PL_pp(ExtU* rtU, motor_t* motor_left, micro_t* micro) {
    ...
    rtU->Wx[3] = CLAMP(0.00001 * SPEED_CALIBRATION, MIN_OMEGA, MAX_OMEGA);
    ...
    rtU->motor_T[2] = CLAMP(40.0 * TEMPERATURE_CALIBRATION, MIN_MOTOR_TEMPERATURE, MAX_MOTOR_TEMPERATURE);
    ...
    rtU->power_limits[0] = CLAMP(1000.0, 0.0, MAX_BATTERY_POWER);
